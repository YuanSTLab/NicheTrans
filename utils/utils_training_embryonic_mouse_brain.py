...
def train_regression(model, criterion, optimizer, trainloader):
    model.train()
    losses = AverageMeter()
...
def train_binary(model, criterion, optimizer, trainloader):
    model.train()
    losses = AverageMeter()
...
def test_regression(model, testloader, if_sigmoid=False):
    model.eval()
...
def test_binary(model, testloader):
    model.eval()
